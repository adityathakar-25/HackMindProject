...
const p = {
  ...
  loading: { color: "#9CA3AF", textAlign: "center", padding: "2rem" },
  skillsRow: {
    display: "grid",
  ...
  empty: { color: "#9CA3AF", fontSize: "0.78rem", fontStyle: "italic" },
  roleSelector: {
    display: "flex",
    gap: "0.75rem",
    marginBottom: "1.25rem",
  ...
  planMeta: { color: "#9CA3AF", fontSize: "0.78rem" },
  confBadge: {
  ...
  weekHours: { color: "#9CA3AF", fontSize: "0.75rem" },
  weekLink: {
    color: "#3B82F6",
    fontSize: "0.75rem",
    textDecoration: "none",
